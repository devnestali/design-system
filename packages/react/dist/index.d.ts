...
import { ComponentProps, ElementType, InputHTMLAttributes, ReactNode } from 'react';
...
declare function Tooltip({ date, disponibility, children }: TooltipProps): react_jsx_runtime.JSX.Element;

type DaysOfWeek = 'domingo' | 'segunda-feira' | 'terça-feira' | 'quarta-feira' | 'quinta-feira' | 'sexta-feira' | 'sábado';
interface ToastProps extends ComponentProps<'button'> {
    dayOfWeek: DaysOfWeek;
    dateOfMonth: string;
    time: number;
    content: string;
}
declare function Toast({ dayOfWeek, dateOfMonth, time, content, ...props }: ToastProps): react_jsx_runtime.JSX.Element;
