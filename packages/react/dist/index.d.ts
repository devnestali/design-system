...
declare const TooltipContentStyled: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Tooltip$1.TooltipContentProps & react.RefAttributes<HTMLDivElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        gray100: string;
        gray200: string;
...
interface TooltipProps extends ComponentProps<typeof TooltipContentStyled> {
    date: string;
